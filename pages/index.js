      ...
      <StyleElement>
        <main className="content">
          ...
          <div className="container">
            ...
            <div className="cards">
              {results.map(({ name, Country_of_origin, Manufacturer }) => {
                // console.log(
          ...
          <div className="container">
            ...
            <div className="cards">
              {views.map(({ Country_of_origin, Manufacturer, name }) => {
                return (
                  <>
                    <div className="card-item">
                      <Image
          ...
          <div style={{ backgroundColor: "#F7F8FC", padding: "80px 0" }}>
            <div className="container">
          ...
          <div style={{ backgroundColor: "#F5F6F6" }}>
            <div className="container">
              <div className="map" style={{ display: "flex" }}>
                ...
                <div className="contacts" style={{ padding: "60px 40px" }}>
